...
public class ChoirMemberRepositoryImpl implements ChoirMemberRepository {
	...
	public ChoirMemberRepositoryImpl(){
		...
		ChoirMember chmem5 = new ChoirMember("Dominika", "355456785");
		ChoirMember chmem6 = new ChoirMember("Jarek", "355456785");
		ChoirMember chmem7 = new ChoirMember("Darek", "355456785");
		ChoirMember chmem8 = new ChoirMember("Szymon", "355456785");
		ChoirMember chmem9 = new ChoirMember("Mateusz", "355456785");
		
		choirMemberList.add(chmem1);
		choirMemberList.add(chmem2);
		choirMemberList.add(chmem3);
		choirMemberList.add(chmem4);
		choirMemberList.add(chmem5);
		choirMemberList.add(chmem6);
		choirMemberList.add(chmem7);
		choirMemberList.add(chmem8);
		choirMemberList.add(chmem9);
	}
